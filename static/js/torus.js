...
(function() {
    ...
    const segments = 60;    // Resolución a lo largo del nudo (optimizado)
    const tubeSegments = 6; // Resolución del grosor del tubo (optimizado)
    ...
    for (let i = 0; i < segments; i++) {
        ...
        // Vectores para generar el volumen del tubo
    ...
    // Registro en el sistema de hero.js
    window.registerMesh("knot", vs, fs);
})();
