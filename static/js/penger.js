...
const finIndex = vertices.length; 
    vertices.push(
        // Aleta Derecha
        {x: 0.18, y: 0.1, z: 0.1},  // Base superior
        {x: 0.45, y: -0.1, z: 0.2}, // Punta
        {x: 0.18, y: -0.1, z: 0.1}, // Base inferior
        // Aleta Izquierda
        {x: -0.18, y: 0.1, z: 0.1}, // Base superior
        {x: -0.45, y: -0.1, z: 0.2},// Punta
        {x: -0.18, y: -0.1, z: 0.1} // Base inferior
    ...
    // Conectamos los nuevos vértices para formar las caras de las aletas
    faces.push([finIndex, finIndex + 1, finIndex + 2]);     // Aleta R
    faces.push([finIndex + 3, finIndex + 4, finIndex + 5]); // Aleta L

    // Registramos este modelo en el sistema global
    window.registerMesh("penger", vertices, faces);
})();
// const vs = [
//     {x: -0.086914, y: 0.277547, z: 0.400041},
//     {x: -0.069555, y: 0.329698, z: 0.376422},
